...
export default function BillDetailsPayment(props: any) {
 ...
 /* const handleChangeRowsPerPage = (event) => {
  ...
  const handleDeleteInvoicePayment = (id: number) => {
    fetch(configData.SERVER_URL + "Purchase/DeleteBillPayment?id=" + id, {
      method: "DELETE",
      headers: {
  ...
  useEffect(() => {
    fetch(
      configData.SERVER_URL +
        "Purchase/GetBillPaymentsByReferenceNo?vendorId=" +
        props.vendorId,
      {
        method: "GET",
        headers: {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <DeleteForeverIcon
                            onClick={() =>
                              handleDeleteInvoicePayment(Number(row.id))
                            }
                          />
                        </TableCell>
                      </TableRow>
